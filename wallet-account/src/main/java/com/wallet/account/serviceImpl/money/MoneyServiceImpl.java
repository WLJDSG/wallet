package com.wallet.account.serviceImpl.money;

import lombok.AllArgsConstructor;
import com.wallet.account.entity.MoneyLog;
import com.wallet.common.error.ErrorCode;
import com.wallet.account.mapper.AccountMapper;
import com.wallet.account.mapper.MoneyLogMapper;
...
public class MoneyServiceImpl implements MoneyService {
    ...
    private long change(Long userId, long delta, String type, String bizNo, String orderNo, String remark) {
        ...
        if (rows == 0) {
            throw new CommonException(ErrorCode.MONEY_NOT_ENOUGH,
