package com.wallet.asset.coupon;
...
import com.wallet.asset.service.coupon.rule.DeductBoundsRule;
import com.wallet.asset.service.coupon.rule.DiscountDeductRule;
import com.wallet.asset.service.coupon.rule.FullCutDeductRule;
import com.wallet.asset.service.coupon.rule.MaxDeductCapRule;
import com.wallet.asset.service.coupon.rule.MinAmountRule;
...
class CouponRuleEngineTest {
    ...
    void minAmountRejected() {
        ...
        assertEquals(AssetError.COUPON_NOT_MATCH.code(), e.getCode());
    }
